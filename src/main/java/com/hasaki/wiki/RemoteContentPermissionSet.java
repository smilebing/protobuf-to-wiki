...
public class RemoteContentPermissionSet  implements java.io.Serializable {
    private com.hasaki.wiki.RemoteContentPermission[] contentPermissions;
    ...
    public RemoteContentPermissionSet(
           com.hasaki.wiki.RemoteContentPermission[] contentPermissions,
     ...
     */
    public com.hasaki.wiki.RemoteContentPermission[] getContentPermissions() {
        return contentPermissions;
    }
     ...
     */
    public void setContentPermissions(com.hasaki.wiki.RemoteContentPermission[] contentPermissions) {
        this.contentPermissions = contentPermissions;
    }

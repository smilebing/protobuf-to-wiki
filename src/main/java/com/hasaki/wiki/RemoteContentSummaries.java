...
public class RemoteContentSummaries  implements java.io.Serializable {
    private com.hasaki.wiki.RemoteContentSummary[] content;
    ...
    public RemoteContentSummaries(
           com.hasaki.wiki.RemoteContentSummary[] content,
           int offset,
           int totalAvailable) {
     ...
     * @return content
     */
    public com.hasaki.wiki.RemoteContentSummary[] getContent() {
        return content;
    }
     ...
     * @param content
     */
    public void setContent(com.hasaki.wiki.RemoteContentSummary[] content) {
        this.content = content;
    }
